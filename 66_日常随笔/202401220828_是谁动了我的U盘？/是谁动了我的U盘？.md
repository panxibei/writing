...
无论你是快乐还是悲伤，只要睁开双眼，就不得不面对着纷繁复杂的世界。

而我们接收到的和所做的一切，都跳不出数据的范畴，正是这些无时无刻都在产生的数据组成了我们的大千世界。



数据在当下的重要性不言而喻，甚至有些对于个人而言被视作生命也不为过。

可偏偏有时，就会发生一些事件，使得我们不得不面对数据泄露丢失的风险。

然而相当多类似的情况却往往发生在我们普通打工人的身上……
...
因此为了让大家都过得更开心、活得更舒心、工作干得更省心，我不辞辛劳将以前写过的做过的相关内容做了一次大整合，同时也开发出了一款船新助手程序软件。
...
A君就职于某传媒公司，最近连续几个晚上熬夜加班终于赶制出了满意的方案，资料文档就放在办公室的电脑中。

可就在第二天午休期间，吃个饭的工夫，回来发现办公室的门虚掩着，顿时怀疑有人趁自己不在，偷偷进入办公室并用U盘拷走了资料。

方案资料是保密的，不可以泄露出去，可要怎么判断电脑是不是接入过U盘呢？
...
问及对方，却得到了否定的回答，遂想求证U盘资料是否被人偷偷拷贝。
...
D君供职于某家大型汽车厂商的设计部门，平时和大量设计图纸打交道。
...
况且图纸资料并非单一文件格式，有的是图片，有的是文档，更多的是 `CAD` 等多种工业软件格式。

这样又怎么定位问题呢？



如果你也遇到此类情况，心情可以理解，着急上火不解决问题。

请不用担心，打开助手程序，点击搜索按钮，所有最近访问文件的记录将会一一呈现在你的面前。

不管是什么文件格式，不管是什么时间打开的，都有迹可循，你就说方不方便吧？
...
注意，有些文件的时间信息是空白，有可能是文件已被删除，或是未正常关闭所致。

因此这并不代表程序有问题，并且目标文件有可能已经不存在了，这个需要小伙伴们注意。
