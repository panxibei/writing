...
按住 **Shift** 键，录制按钮从 ***“录制新曲目”变***![录制按钮](m/images/e/e8/record.png)为![“录制新轨道”按钮](m/images/7/72/record_new_track.png)“录制新曲目”。
...
![](m\troubleshooting\solving-recording-problems\crackles-pops-and-distortion-in-the-recording\01.png)
...
![](m\troubleshooting\solving-recording-problems\crackles-pops-and-distortion-in-the-recording\02.png)
...
![](m\troubleshooting\missing-features\01.png)
...
- **减少屏幕重绘：**至少缩[小](zooming.html)到要录制的整个长度，或者在[轨道偏好设置](tracks_preferences.html)中，取消选中![未选中复选框](../m/images/a/a8/checkboxnotchecked.png)如果头部未固定，则自动滚动。
...
然后，您录制的曲目将在其[轨道控制面板](audio_tracks.html#panel)中显示“立体声”，当您按下**“录制”**![录制按钮的图像](../m/images/e/e8/record.png)按钮时，将显示左上方右上方的两个通道。
...
2. 在对话框中，在将最大幅度归一化为：中![选中复选框](../m/images/8/85/checkboxchecked.png)打勾，然后键入所需的***[幅度](glossary.html#amplitude)***级别*（如果要进行进一步编辑，则 -6 dB 是一个不错的选择）。*
3. 在 Normalize stereo channel independently 中![选中复选框](../m/images/8/85/checkboxchecked.png)打勾。然后按 OK 按钮。
...
在播放期间，也可以在播放过程中使用每个通道[上的增益/音量滑块![轨道增益滑块](../m/images/a/ae/trackgain.png)](https://alphamanual.audacityteam.org/man/File:TrackGain.png)将轨道分成两个通道时执行自定义重新平衡。
...
在删除![选中复选框](../m/images/8/85/checkboxchecked.png)任何直流偏移框中打勾，但未![未选中复选框](../m/images/a/a8/checkboxnotchecked.png)选中标准化最大幅度......框，然后按确定按钮。
