...
英文：best-practice-of-urbackup-backup-on-windows
...
这么好的一款工具软件，我当然要抓过来学习学习了，可一上网，这才发现官网是全英文的，而且介绍特别简单，没几句话，更别说是中文说明了。

我想着可能是作者怕多说几个字会破产，因此只好硬着头皮边学边将 `UrBackup` 的介绍说明给翻译出来。

就是在这个过程中，我学到了不少关于 `UrBackup` 的知识。

而现实场景中又以 `Windows` 平台使用的情况居多，所以我将个人实验体会接合学习翻译手册等经历向小伙伴分享一下在 `Windows` 平台上如何更好地运用 `UrBackup` 备份。



本文七千多字、100多幅图片，是我花费数周总结的，请尊重我的劳动成果。

转载可不必向我申请授权，但必须注明作者和出处，同时附上原文链接。

为避免网络采集，我将文章设定为付费状态，请小伙伴理解！
