...
这个世界从来都不缺大神，然而大神们除了拥有惊人发量的特点外，更加鲜为人知的却是三个字：闲得蛋疼！

没错，能称得上大神的多少有点吃饱了撑的，不过这只是我们外人看来的，大神们从来不屑于我等小白的眼光，他们的眼睛只会一如既往地向前展望。

之前有幸为小伙伴们介绍过一篇文章，说的正是俄罗斯的大神们反对帝国主义垄断和压迫，走了一独立自主的光明大道，开发了一款纯汇编操作系统 `KolibriOS` 的故事。
...
于是乎看过此文的不少小伙伴热血沸腾、直呼牛逼，他们呼喊着要是我们也能出些大神那就太好了，至少不会被帝国主义卡脖子。

此情此景我是非常感动的，但是我已经过了35岁的高龄，已经不能再投入火热的技术学习之中，也不能再为大家贡献自己的微薄力量了。

虽然有些伤感，但是却有一个好消息要带给大家，那就是我又发现一款新系统！

嘿嘿，没错，这款新系统也是纯汇编撸成的，名叫 `MenuetOS` ，不过创作者不是战斗民族而是来自日不落大英帝国的大神们。

好奇吗？接下来我们就一起瞧瞧盎格鲁撒克逊大神们用汇编撸成 `MenuetOS` ！



 `MenuetOS` 究竟有什么特性，按照我个人的理解，我们还是找个镜像或什么先安装用用看，用着用着不就知道都有什么特性了嘛！

我们来到官网，首页非常简朴，堪称节约成本之业界楷模，为了不占更多的篇幅，因此我就不在这儿贴图了。
...
实际上 `MenuetOS` 被制作得非常之小，以至于可以放到一张 `1.44MB` 的软盘上，因此官网上提供了软盘镜像下载。

图中第一个箭头指的就是软盘镜像，第二个箭头指的是 `Windows` 下将镜像写入软盘的工具软件。

图01



再看看这个 `Windows` 工具，它居然点名要写到 `A` 盘，也就是软盘。
...
而 `64` 位系统流行的今天怎么可能还用软盘呢，因此官网又提供了另外一种支持光驱镜像的方法。
...
然后将这两个压缩包解压，放出两个文件，一个叫 `isohdr` ，另一个叫 `M6413970.IMG` 。
...
说实话，以前学 `copy` 这个命令的时候，也就简单地合并过两个文本文件，没想到多年之后的今天，居然见识到了还可以这样合并引导文件的。
...
还有，游戏肯定是少不了，这也许是大神们坚持下去的动力之一吧，毕竟大神也会累嘛，娱乐一下也很必要。

图12



此外大神们还搞出了一些复古游戏，比如 `Quake` 和 `Doom` 等等，官网上提供 `CD` 下载。
...
然而就这么设置并进入系统后，并不能直接使用网络，还得费点功夫设置一下。

首先，点击桌面的 `setup` ，并在设置界面中确认网卡驱动。
...
不过嘛，令人沮丧的是，这个 `HTTPC` 浏览器并不支持 `https` 协议，凑合着用吧，要求不能太高。
...
还有内存大小，默认是 `640MB` ，我配置了 `1GB` 内存，改成 `0x000400` 。
...
这款 `MenuetOS` 从 `2005` 年直到现在都一直在更新，可以看得出，大神们不是真的闲，而是他们的敬业奉献精神。

除了自身的爱好，对编程技术的热爱外，更多的是让更多人能从这款系统中受益。
...
就像有的小伙伴感叹的那样，我们也不缺大神，但何时我们的大神也能闲到撸一个有点那么意思的系统出来呢？
