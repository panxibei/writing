...
`PDF` 文件操作开源神器：`Stirling PDF` 。

这是个好东东，对于经常要操作 `PDF` 文件的小伙伴是个不可多得的利器。

比如分割、合并，转换、重排，盖个章、签个字啥的，都不在话下。

网上介绍的比较多，我就不多啰嗦了，我们聊一些网上没有的，而对我们也有帮忙的内容。



这个 `Stirling PDF` 可以让我们对 `PDF` 文档实现各种神奇的操作，但说它的重点其实是因为它不仅开源免费，而且它可以放在自己的电脑上单独用。

就这一点来说，相信很多小伙伴应该是深有体会吧，有些 `PDF` 文档还是比较机密的，不可能放到网上去做些什么操作，万一泄密可就没有万一了。

好，既然把它说得这么好，那么我们就来介绍一下怎么个用法吧！
...
接下再找一个“页面操作”中的“拆分 `PDF` ”功能来展开说明一下。
