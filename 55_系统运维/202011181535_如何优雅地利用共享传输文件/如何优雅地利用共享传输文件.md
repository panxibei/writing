...
strMail = " " & strNewLine & " " & strNewLine &_
          ...
          "     I inform you a temporary area to transmit files between company PCs." & strNewLine &_
          "     You click the above AccessPATH, and please store files to your PC." & strNewLine &_
          "     Files are automatically deleted at " & Mid(strDate, 5, 2) & "/" & Right(strDate, 2) & "/" &Left(strDate, 4) & "(MM/DD/YYYY)." & strNewLine &_
